                ...
                <div class="main-menu collapse navbar-collapse" id="nav-content">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item"><a href="{{ url('/Contacto') }}" title="Services">Ver
                                        Directorio Telefonico</a></li>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active w-100">
                    <img src="assets/images/Logo.jpg" class="w-50" alt="..." style="margin-left: 25%">
                </div>
                <div class="carousel-item  w-100">
                    <img src="assets/images/Productos.jpg" class="w-50" alt="..." style="margin-left: 25%">
                </div>
                ...
                <nav aria-label="Page navigation example">
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item disabled"><a class="page-link" href="#" tabindex="-1"><i
                                    class="flat flaticon-back"></i></a></li>
    ...
    <div class="container">
        <div class="copyright col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> Copyright &copy; 2025
