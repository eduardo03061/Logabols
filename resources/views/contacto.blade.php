...
<head>
    ...
    <meta name="keywords"
          content="Business , Bootstrap4, Responsive, HTML5, CSS3, Carousel, Website Template, Revolution, UI Development, Bizler">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-item"><a href="#" title="Services">Ver Directorio Telefonico</a>
                                </li>
    ...
    <section id="blog-post-list">
        ...
        <div class="container">
            <table class="table">
                ...
                <tr>
                    <th scope="row">Oficina arandas jalisco</th>
                    <td>Oficinas</td>
                    <td>348 783 0850</td>
                    <td>logabols@ yahoo.com.mx</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row">Puebla, Veracruz, Tabasco, Chiapas y Oaxaca</th>
                    <td>Jose Antonio Cuevas</td>
                    <td>222 340 9981</td>
                    <td>jose_a_cuevas@hotmail.com</td>
                </tr>
                <tr>
                    <th scope="row">Chihuahua, Durango, Coahuila y Nuevo León</th>
                    <td>Juan Carlos</td>
                    <td>871 135 8989</td>
                    <td>jclogabols@gmail.com</td>
                </tr>
                <tr>
                    <th scope="row">Jalisco, Nayarit y Zacatecas</th>
                    <td>Gustavo Orendai amaya</td>
                    <td>331 250 7918</td>
                    <td>gustavorendain_95 @hotmail.com</td>
                </tr>
                </tbody>
            </table>
